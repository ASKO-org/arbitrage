...
// Streams best bid/ask via OKX's "bbo-tbt" public channel for SWAP (USDT-
// margined perpetual) instIds. Same shared WS host and heartbeat pattern as
// OkxSpotMarketDataConnector.
class OkxFutMarketDataConnector : public IMarketDataConnector {
public:
    OkxFutMarketDataConnector();
    ~OkxFutMarketDataConnector() override;
